...
class Models:
    ...
    def comprehensive_genus_modeling(self, genus_name, presence_path=None, absence_path=None):
        ...
        try:
            ...
            presence_features.to_csv(presence_path, index=False)
            absence_features.to_csv(absence_path, index=False)
            ...
            X, y, reliability_weights, bias_weights, combined_weights = self.apply_bias_correction(
                presence_clean, absence_clean, feature_cols
            )
    ...
    def apply_bias_correction(self, presence_df, absence_df, feature_cols):
        ...
        presence_features = presence_df[feature_cols].values.astype(float)
...
if __name__ == "__main__":
    ...
    #     "Ficus carica"
    # ]
    # species_list = ["Artocarpus heterophyllus","Cocos nucifera","Moringa oleifera","Mangifera indica","Azadirachta indica","Dalbergia sissoo"]
    genus_list = ["Macaranga","Artemisia"]
